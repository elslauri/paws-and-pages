...
namespace Project.Classes.Scenes.Levels
{
    ...
    {
        public AdvancedLevel(GraphicsDeviceManager graphics, SpriteBatch spriteBatch, ContentManager content, GameManager gameManager, LevelConfiguration config)
        ...
        protected override void InitializeGameObjects()
        {
            ...
            books.AddRange(bookSpawnManager.SpawnBooks(bookTexture, bookshelves, 0.8f)); 
